...
// Section : glutils-browser
    ...
    _.escapeString = function (s) {
        return s.replace(/\\/g, '\\\\').replace(/\t/g, '\\t').replace(/\n/g, '\\n').replace(/\r/g, '\\r').replace(/'/g, '\\\'').replace(/"/g, '\\\"').replace(/[\u0000-\u001F]|[\u0080-\uFFFF]/g, _.escapeUnicodeChar)
    }
    ...
    _.escapeXml = function (s) {
        s = s.replace(/&/g, "&amp;")
        s = s.replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&apos;").replace(/"/g, "&quot;").//            replace(/[\u0000-\u001F]|[\u0080-\uFFFF]/g, function (c) {
...
// Section : glutils-promises
    ...
    _.run = function (f, x) {
        ...
        else if (f != c && f.started && !f.yielding)
            var ret = f.run(x)
    ...
    _.wget = function (method, url, params, encoding) {
        ...
        if (!o.method.match(/^get$/i)) {
            if (!params) {
                ...
                var data = _.values(_.map(params, function (v, k) {
